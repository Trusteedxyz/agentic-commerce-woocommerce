...
var Cw = (se, le, _e) =>
  le in se
    ? Sw(se, le, { enumerable: !0, configurable: !0, writable: !0, value: _e })
    : (se[le] = _e);
var _n = (se, le, _e) => Cw(se, typeof le != "symbol" ? le + "" : le, _e),
...
` + a[o].replace(" at new ", " at ");
  ...
  var ld = it.unstable_scheduleCallback,
    ...
    Bo = it.unstable_ImmediatePriority,
    ...
    Zs = he({}, za, {
      ...
      movementX: function (e) {
        return "movementX" in e
          ...
          : (e !== Ba &&
              (Ba && e.type === "mousemove"
                ? ((Go = e.screenX - Ba.screenX), (Yo = e.screenY - Ba.screenY))
                : (Yo = Go = 0),
              (Ba = e)),
            Go);
      },
  ...
  var Mg = he({}, za, {
    ...
    qa = null;
  Vt && "documentMode" in document && (qa = document.documentMode);
  var Hg = Vt && "TextEvent" in window && !qa,
    jd = Vt && (!el || (qa && 8 < qa && 11 >= qa)),
    Nd = " ",
    Ad = !1;
  function Ed(e, t) {
    switch (e) {
  ...
  function ay(e) {
    ...
    if (
      ...
      r &&
      r.ownerDocument &&
      Bd(r.ownerDocument.documentElement, r)
    ) {
      if (n !== null && nl(r)) {
        if (
          ((t = n.start),
...
`
  ...
  function kr() {
    if (!vl && Ht !== null) {
      ...
      try {
        ...
        throw (Ht !== null && (Ht = Ht.slice(e + 1)), ld(Bo, kr), a);
      } finally {
        ((ie = t), (vl = !1));
      }
    }
  ...
  function wy(e, t, r) {
    ...
    if (Fp(e)) zp(t, a);
      ...
      ((r = fp(e, t, a, n)),
        r !== null && ((a = He()), Nt(r, e, n, a), Bp(r, t, n)));
    }
  }
  function Fp(e) {
    var t = e.alternate;
...
` +
  ...
  function Ay(e, t, r) {
    ...
    switch ((bl(t), t.tag)) {
      ...
      case 10:
        return (Rl(t.type._context), qe(t), null);
      case 17:
        return (Xe(t.type) && ai(), qe(t), null);
      case 19:
  ...
  function jm(e, t) {
    t === 0 &&
      ((e.mode & 1) === 0
        ? (t = 1)
        : ((t = Bs), (Bs <<= 1), (Bs & 130023424) === 0 && (Bs = 4194304)));
    var r = He();
  ...
  ((hd = function (e) {
    ...
    (td = uc),
    (rd = rn));
  var Qy = { usingClientEntryPoint: !1, Events: [Ga, Bn, ni, Ju, ed, uc] },
    us = {
  ...
  var y0 =
    ((gf = class extends Hm {
      ...
      async execute(t) {
        const r = () => {
            Q(this, qt, Kr).call(this, { type: "continue" });
          },
          n = {
            client: h(this, ws),
        ...
        L(
          ...
          Wm({
            ...
            onPause: () => {
              Q(this, qt, Kr).call(this, { type: "pause" });
            },
            onContinue: r,
        ...
        try {
          ...
          return (
            ...
            Q(this, qt, Kr).call(this, { type: "success", data: o }),
            o
          );
        } catch (o) {
          try {
          ...
          throw (Q(this, qt, Kr).call(this, { type: "error", error: o }), o);
        } finally {
  ...
  var v0 =
    ((yf = class extends ta {
      ...
      find(t) {
        const r = { exact: !0, ...t };
        return this.getAll().find((n) => Bm(r, n));
      }
      findAll(t = {}) {
        return this.getAll().filter((r) => Bm(t, r));
      }
      notify(t) {
        Ee.batch(() => {
          this.listeners.forEach((r) => {
      ...
      ((bf = class {
        constructor(e = {}) {
          ...
          (L(this, be, e.queryCache || new b0()),
            L(this, qr, e.mutationCache || new v0()),
        ...
        isMutating(e) {
          return h(this, qr).findAll({ ...e, status: "pending" }).length;
        }
        getQueryData(e) {
        ...
        resumePausedMutations() {
          return $i.isOnline()
            ? h(this, qr).resumePausedMutations()
            : Promise.resolve();
        }
        getQueryCache() {
          return h(this, be);
        ...
        clear() {
          (h(this, be).clear(), h(this, qr).clear());
        }
      }),
      (be = new WeakMap()),
      (qr = new WeakMap()),
  ...
  class tr extends X {
    ...
    regex(t, r) {
      return this._addCheck({ kind: "regex", regex: t, ...q.errToObj(r) });
    }
    includes(t, r) {
    ...
    startsWith(t, r) {
      return this._addCheck({ kind: "startsWith", value: t, ...q.errToObj(r) });
    }
    endsWith(t, r) {
      return this._addCheck({ kind: "endsWith", value: t, ...q.errToObj(r) });
    }
    min(t, r) {
      return this._addCheck({ kind: "min", value: t, ...q.errToObj(r) });
    }
    max(t, r) {
      return this._addCheck({ kind: "max", value: t, ...q.errToObj(r) });
    }
    length(t, r) {
      return this._addCheck({ kind: "length", value: t, ...q.errToObj(r) });
    }
    nonempty(t) {
  ...
  class na extends X {
    ...
    setLimit(t, r, n, a) {
      return new na({
        ...
        checks: [
          ...this._def.checks,
          { kind: t, value: r, inclusive: n, message: q.toString(a) },
        ],
      });
    }
    _addCheck(t) {
            ...
            ? {
                errorMap: (r, n) => {
                  ...
                  return r.code === "unrecognized_keys"
                    ? { message: q.errToObj(t).message ?? a }
                    : { message: a };
                },
              }
            : {}),
  ...
  Bc.create = (e, t) => new Bc({ getter: e, typeName: K.ZodLazy, ...W(t) });
  class Gi extends X {
    _parse(t) {
  ...
  qc.create = (e, t) =>
    new qc({ values: e, typeName: K.ZodNativeEnum, ...W(t) });
  class Yi extends X {
    unwrap() {
      return this._def.type;
    }
  ...
  const oa = new Fv(),
    ...
    Gc = (e) => {
      const t = zv.VITE_TRUSTEED_API_URL;
      if (t) return t;
  ...
  function Wv({ children: e, locale: t }) {
    const r = t ?? Vh(),
      n = N.useMemo(() => Kv[r], [r]);
  ...
  const Qv = j({ success: Oe(), ticketNumber: k().optional() }),
    ar = [];
  typeof window < "u" &&
  ...
  const Yv = new w0({
    ...
    Xv = (e) => {
      switch (e) {
        case "inicio":
          return we(() => Promise.resolve().then(() => sx), void 0);
        case "payment-methods":
          return we(() => Promise.resolve().then(() => Gh), void 0);
        case "settings":
          return we(() => Promise.resolve().then(() => fx), void 0);
        case "merchant-center":
          return we(() => Promise.resolve().then(() => Nx), void 0);
        case "mis-ventas":
          return we(() => Promise.resolve().then(() => $x), void 0);
        case "mis-reglas":
          return we(() => Promise.resolve().then(() => pb), void 0);
        case "seguridad":
          return we(() => Promise.resolve().then(() => bb), void 0);
        case "agentes":
          return we(() => Promise.resolve().then(() => sf), void 0);
        default:
          return we(() => Promise.resolve().then(() => jb), void 0);
      }
    },
    Jv = ({ initialSection: e, onRegisterNavigate: t }) => {
  ...
  const tx = j({ activated: Oe(), kid: k() }),
    rx = new Intl.DateTimeFormat("es-ES", {
      dateStyle: "short",
      timeStyle: "short",
      timeZone: "UTC",
    }),
      ...
      Object.defineProperty(
        {
          ...
          default: () => {
            const e = xe(),
              ...
              u = xt({
                mutationFn: () =>
                  ne.post("/v1/embed/trust/keys/activate", {}, tx),
                onSuccess: () => {
                ...
                i.jsxs("section", {
                  ...
                  children: [
                    ...
                    i.jsx("div", {
                      className: "p-6",
                      children: n
                        ? i.jsx(ax, { ariaLabel: e.inicio.scoreAriaLoading })
                        : i.jsxs("div", {
                            className: "space-y-4",
                            children: [
                              i.jsxs("div", {
    ...
    dx = ({ method: e, onSuccess: t, onError: r, t: n }) => {
      const a = {
        ...
        s = lx[e.status] ?? "bg-gray-100 text-gray-500",
      ...
      return i.jsxs("div", {
        ...
        children: [
          ...
          i.jsx(ux, { method: e, onSuccess: t, onError: r, t: n }),
        ],
      });
    },
    px = () =>
          ...
          default: () => {
            const e = xe(),
              { toasts: t, add: r, remove: n } = cx(),
              {
                ...
                queryKey: ["pm-catalog"],
                queryFn: () =>
                  ne.get("/v1/embed/merchant/payment-methods/catalog", ox),
              }),
          ...
          default: () => {
            const e = xe(),
              ...
              u = ye({
                ...
                queryFn: () => ne.get("/v1/embed/merchant/config", mx),
              }),
              [p, f] = N.useState(null),
    ...
    yx = () => ne.get("/v1/embed/merchant/shops", gx),
    vx = ({ onShopChange: e }) => {
      const t = xe(),
        {
          data: r,
    ...
    xx = ce.lazy(() => we(() => Promise.resolve().then(() => Lb), void 0)),
    bx = ce.lazy(() => we(() => Promise.resolve().then(() => Gh), void 0)),
    wx = ce.lazy(() => we(() => Promise.resolve().then(() => sf), void 0)),
    kx = ce.lazy(() => we(() => Promise.resolve().then(() => Ib), void 0)),
    Sx = ce.lazy(() => we(() => Promise.resolve().then(() => $b), void 0)),
    Cx = {
      "#orders": "orders",
      "#payments": "payments",
      "#agents": "agents",
      ...
      Object.defineProperty(
        {
          ...
          default: () => {
            ...
            const o = N.useCallback((c) => {
                (r(c), window.history.replaceState(null, "", _x[c]));
              }, []),
              l = N.useCallback((c) => {
                a(c);
              }, []);
            return i.jsxs("div", {
              ...
              children: [
                ...
                i.jsxs(N.Suspense, {
                  fallback: i.jsx(jx, { loading: e.merchantCenter.loading }),
                  children: [
                    t === "orders" && i.jsx(xx, {}),
                    t === "payments" && i.jsx(bx, {}),
                    t === "agents" && i.jsx(wx, {}),
                    t === "checkout" && i.jsx(kx, {}),
                    t === "cert-nlweb" && i.jsx(Sx, {}),
                  ],
                }),
              ],
            });
    ...
    Ax = ce.lazy(() => we(() => Promise.resolve().then(() => Zb), void 0)),
    Ex = ce.lazy(() => we(() => Promise.resolve().then(() => nw), void 0)),
    Tx = ce.lazy(() => we(() => Promise.resolve().then(() => ow), void 0)),
    Px = ce.lazy(() => we(() => Promise.resolve().then(() => yw), void 0)),
    Ox = { "#ventas-ia": "receipts", "#claves": "keys", "#auditoria": "audit" },
    Lx = {
      orders: "",
      receipts: "#ventas-ia",
      keys: "#claves",
    ...
    Xh = (e) => Ox[e] ?? "orders",
    Dx = new Intl.DateTimeFormat("es-ES", {
      dateStyle: "short",
      timeStyle: "short",
      timeZone: "UTC",
    }),
    ...
    Bx = ({ active: e, onChange: t, tabs: r, ariaLabel: n }) =>
      i.jsx("nav", {
            ...
            return i.jsxs("div", {
              ...
              children: [
                ...
                i.jsxs(N.Suspense, {
                  ...
                  children: [
                    t === "orders" && i.jsx(Ux, {}),
                    t === "receipts" && i.jsx(Ax, { onSelect: a }),
                    t === "keys" && i.jsx(Tx, {}),
                    t === "audit" && i.jsx(Px, {}),
                  ],
                }),
                n !== null &&
                  i.jsx(N.Suspense, {
                    fallback: null,
                    children: i.jsx(Ex, { receipt: n, onClose: () => a(null) }),
                  }),
              ],
            });
          },
  ...
  const Hx = ({
    ...
    tu = {
      ...
      R014: {
        schema: j({
          highRiskCountries: Z(Qx).optional(),
    ...
    Yx = j({ rules: Z(Gx), version: z() }),
    Xx = /^(R\d{3})/;
  function Jx(e) {
    const t = Xx.exec(e.trim().toUpperCase());
    return t ? t[1] : null;
  }
  const eb = {
  ...
  const ob = j({
          ...
          default: () => {
            const e = xe(),
              ...
              m = ye({
                ...
                queryFn: () => ne.get("/v1/embed/merchant/rules", lb),
              }),
              x = ye({
              ...
              C = (m.data?.rules ?? (m.isError ? ub : [])).filter((S) => {
    ...
    hb = new Intl.DateTimeFormat("es-ES", {
      dateStyle: "long",
      timeZone: "UTC",
    }),
    fb = (e) => {
                                          ...
                                          "tr",
                                          {
                                            ...
                                            children: [
                                              i.jsx("td", {
                                                className:
                                                  "px-4 py-3 text-gray-500",
                                                children: fb(v.createdAt),
                                              }),
                                              i.jsx("td", {
                                                className: "px-4 py-3",
                                                children: i.jsx("span", {
                                                  className: `rounded-full px-2 py-0.5 text-xs font-medium ${yb[v.source] ?? "bg-gray-100 text-gray-600"}`,
                                                  children:
                                                    s[v.source] ?? v.source,
                                                }),
                                              }),
    ...
    kb = { allow: "✅", probation: "👁️", block: "🚫", pending: "⏳" },
    Sb = () =>
      i.jsx("tr", {
        children: Array.from({ length: 5 }).map((e, t) =>
          i.jsx(
        ...
        children: [
          ...
          i.jsx("td", {
            ...
            children: i.jsxs("span", {
              className: `rounded-full px-2 py-0.5 text-xs font-medium ${wb[p] ?? "bg-gray-100 text-gray-500"}`,
              children: [kb[p] ?? "", " ", u[p] ?? p],
            }),
          }),
          i.jsx("td", {
    ...
    _b = ce.lazy(() => we(() => Promise.resolve().then(() => kw), void 0)),
    Rb = ({ loading: e }) =>
      i.jsx("div", { className: "p-6 text-sm text-gray-500", children: e }),
    jb = Object.freeze(
      Object.defineProperty(
          ...
          default: () => {
            ...
            return i.jsxs("div", {
              ...
              children: [
                ...
                i.jsx(N.Suspense, {
                  fallback: i.jsx(Rb, { loading: e.trustCenter.loading }),
                  children: i.jsx(_b, {}),
                }),
              ],
            });
    ...
    Nb = new Intl.DateTimeFormat("es-ES", {
      dateStyle: "short",
      timeStyle: "short",
      timeZone: "UTC",
    }),
            ...
            return i.jsxs(
              "li",
              {
                ...
                children: [
                  ...
                  i.jsx(ru, {
                    label: c[u] ?? (u || "—"),
                    classes: Mb[u] ?? "bg-gray-100 text-gray-500",
                  }),
                ],
              },
              s
                      ...
                      children: [
                        ...
                        i.jsx(ru, {
                          label:
                            ...
                            (r?.status || "—"),
                          classes:
                            Fb[r?.status ?? ""] ?? "bg-gray-100 text-gray-500",
                        }),
                      ],
                    }),
                    i.jsxs("div", {
    ...
    Vb = new Intl.DateTimeFormat("es-ES", {
      dateStyle: "short",
      timeStyle: "short",
      timeZone: "UTC",
    }),
      ...
      Object.defineProperty(
        {
          ...
          default: ({ onSelect: e }) => {
            const t = xe(),
              ...
              n = ({ bucket: S }) =>
                i.jsx("span", {
                  className: `rounded-full px-2 py-0.5 text-xs font-medium ${Wb[S] ?? "bg-gray-100 text-gray-700"}`,
                  children: r[S] ?? S,
                }),
              [a, s] = N.useState(""),
  ...
  const Xb = ({ receiptId: e }) => {
      const t = xe(),
        ...
        o = N.useCallback(async () => {
          ...
          try {
            const l = await Gb(),
              c = await fetch(
                `${Uv()}/v1/embed/trust/export/${encodeURIComponent(e)}`,
                {
                  method: "GET",
                  headers: {
                    "X-Embed-Source": Uh(),
    ...
    tw = (e) => {
      try {
        return `${ew.format(new Date(e))} UTC`;
      } catch {
        return e;
      }
    },
                      ...
                      i.jsxs("dl", {
                        ...
                        children: [
                          ...
                          i.jsx(Lr, {
                            ...
                            value: i.jsx("span", {
                              className: `inline-block rounded-full px-2 py-0.5 text-xs font-medium ${rw[e.bucket] ?? "bg-gray-100 text-gray-700"}`,
                              children: e.bucket,
                            }),
                          }),
                          i.jsx(Lr, {
    ...
    aw = new Intl.DateTimeFormat("es-ES", {
      dateStyle: "medium",
      timeZone: "UTC",
    }),
    sw = (e) => {
          ...
          default: () => {
            ...
            return i.jsxs("div", {
              ...
              children: [
                ...
                r && i.jsx(iw, { ariaLabel: e.trustKeys.ariaLoading }),
                n &&
                  i.jsxs("div", {
                    className:
                      "rounded border border-red-300 bg-red-50 px-4 py-3 text-sm text-red-700",
    ...
    pw = ({ source: e, t }) => {
      ...
      return i.jsx("span", {
        className: `rounded-full px-2 py-0.5 text-xs font-medium ${dw[e] ?? "bg-gray-100 text-gray-700"}`,
        children: r[e] ?? e,
      });
    },
    mw = new Set(["ok", "success", "allow", "token_refresh_seamless"]),
    hw = ({ outcome: e, t }) => {
      const r = mw.has(e),
    ...
    ww = ({ name: e, dim: t, confidenceLevel: r, t: n }) => {
      const a = {
      ...
      Object.defineProperty(
        {
          ...
          default: () => {
            const e = xe(),
              ...
              c = xt({
                mutationFn: () =>
                  ne.post("/v1/embed/trust/keys/activate", {}, vw),
                onSuccess: () => {
